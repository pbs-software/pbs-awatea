...
if(getRversion() >= "2.15.1") utils::globalVariables(names=c(
	...
	"istock",
	"J",
	"lang","likdat","linguaFranca","lucent",
	"MAexp","mainTitle","MAobs","maxcol","maxgrad","mess","minCpueYr","mpd.dir",
	...
	"R0.mpd","redo.Graphs","refPointsList","refPointsHistList","refs","resdoc","resetGraph","resFileList","rpType","rwtNo",
